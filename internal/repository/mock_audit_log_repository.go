...
// Source: internal/repository/audit_log_repository.go
//
// Generated by this command:
//
//	mockgen -source=internal/repository/audit_log_repository.go -destination=internal/repository/mock_audit_log_repository.go -package=repository
//
